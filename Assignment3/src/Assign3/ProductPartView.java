...
public class ProductPartView extends JFrame implements PartObserver {
	...
	public ProductPartView(InventoryController i, Part p) {
		part = p;
		invC = i;
		...
		button.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				Part p = invC.addProduct(ProductPartView.this, part, tfPartNum.getText(), tfPartName.getText(), tfVendor.getText(), Integer.parseInt(tfQty.getText().trim()), Integer.parseInt(tfID.getText()), tfExNum.getText(), tfLoc.getText());
				if(p != null) {
					if(part == null) {
						part = p;
						part.registerObserver(ProductPartView.this);
						ProductPartView.this.setTitle("Editing " + part.getPartName());
					} else
						part = p;
				}
			}
